...
var BREWTYPEVALUES = [{ id: "drip", name: "Drip" }, { id: "immersion", name: "Immersion" }, { id: "espresso", name: "Espresso" }];

var ExtractionWidget = React.createClass({
    displayName: 'ExtractionWidget',
    ...
    renderInputs: function (brewType) {
        ...
        switch (brewType) {
            case "drip":
            case "immersion":
                params = ["water", "coffee", "tds", "absorption"];
                break;
            case "espresso":
                params = ["coffee", "yield", "tds"];
                break;
            default:
                params = [];
        }
        ...
        for (var i = 0; i < params.length; i++) {
            ...
            inputs.push(React.createElement(InputBox, {
                key: params[i],
    ...
    renderOutputs: function (brewType) {
        ...
        switch (brewType) {
            case "drip":
            case "immersion":
                params = ["yield", "extraction", "ratio"];
                break;
            case "espresso":
                params = ["extraction", "ratio"];
                break;
            default:
                params = [];
        }
        ...
        for (var i = 0; i < params.length; i++) {
            ...
            outputs.push(React.createElement(OutputBox, { key: params[i], boxValue: this.state[stateName], structure: OUTPUT[params[i]] }));
        }

        return React.createElement(
            'div',
            { key: 'outputs', className: 'outputs' },
            outputs
        );
    },
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'div',
                        { className: 'section' },
                        React.createElement(BrewTypeSelectorButton, { brewType: this.state.brewType, showBrewTypeMenu: this.state.showBrewTypeMenu, toggleBrewTypeMenu: this.toggleBrewTypeMenu })
                    )
                )
            ),
            React.createElement(BrewTypeMenu, { data: BREWTYPEVALUES, brewType: this.state.brewType, selectBrewType: this.selectBrewType, showBrewTypeMenu: this.state.showBrewTypeMenu }),
            React.createElement(
                'div',
                { id: 'content' },
                outputs,
...
var InputBox = React.createClass({
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement(
                'div',
                { id: this.props.structure.id, className: 'inputBox' },
                React.createElement('input', { type: 'text', value: this.props.boxValue, onChange: this.update, onFocus: this.onTextFocus, onBlur: this.onTextBlur }),
                React.createElement(
                    'div',
                    { className: 'sliderbox-title' },
                    this.props.structure.text
                )
            ),
            React.createElement(
                'div',
...
var OutputBox = React.createClass({
    ...
    render: function () {
        return React.createElement(
            'div',
            { id: this.props.structure.id, className: 'outputBox' },
            React.createElement('input', { type: 'text', value: this.props.boxValue, readOnly: true }),
            React.createElement(
                'div',
                { className: 'sliderbox-title' },
                this.props.structure.text
...
ReactDOM.render(React.createElement(ExtractionWidget, null), document.getElementById('wrapper'));
